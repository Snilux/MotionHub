...
const MONGODB_URI =
  ...
  "mongodb://admin:admin123@localhost:27017/motionhub?authSource=admin";
...
const ExpedienteSchema = new mongoose.Schema(
  {
    ...
    peso: Number,
    evolucion: [
      { fecha: Date, nota: String, medico: mongoose.Schema.Types.ObjectId },
    ],
  },
  { timestamps: true },
);
...
async function seed() {
  ...
  const rutina1 = await Rutina.create({
    ...
    ejercicios: [
      {
        nombre: "Contracción cuádriceps en extensión",
        descripcion:
          "Acostado boca arriba, contraer el cuádriceps sin mover la pierna. Mantener 5 segundos.",
        series: 3,
        repeticiones: 15,
        descanso: 30,
      },
      {
        ...
        descripcion:
          "Elevar la pierna a 45° sin doblar la rodilla. Bajar lentamente.",
        series: 3,
        repeticiones: 10,
        descanso: 45,
      },
      {
        nombre: "Flexión pasiva de rodilla",
        descripcion:
          "Con ayuda de una toalla, doblar la rodilla suavemente hasta el límite del dolor.",
        series: 2,
        repeticiones: 10,
        descanso: 60,
      },
      {
        nombre: "Hielo en rodilla",
        descripcion:
          "Aplicar bolsa de hielo envuelta en toalla. No aplicar directo sobre la piel.",
        series: 1,
        repeticiones: 1,
        descanso: 0,
        notas: "20 minutos, 3 veces al día",
      },
    ],
  });
  ...
  const rutina2 = await Rutina.create({
    ...
    activa: true,
    fechaInicio: daysAgo(21),
    ejercicios: [
      {
        nombre: "Puente de glúteos",
        descripcion:
          "Acostado boca arriba, pies en el suelo. Elevar cadera hasta alinear con rodillas y hombros.",
        series: 3,
        repeticiones: 12,
        descanso: 45,
      },
      {
        nombre: "Bird-dog",
        descripcion:
          "En cuatro puntos, extender brazo y pierna contrarios manteniendo espalda recta.",
        series: 3,
        repeticiones: 10,
        descanso: 30,
      },
      {
        ...
        descripcion: "Mantener posición de plancha apoyado en antebrazos.",
        series: 3,
        repeticiones: 1,
        descanso: 60,
        notas: "Mantener 20-30 segundos cada repetición",
      },
      {
        nombre: "Estiramiento de flexores de cadera",
        descripcion:
          "En posición de caballero, inclinar el cuerpo hacia adelante suavemente.",
        series: 2,
        repeticiones: 1,
        descanso: 30,
        notas: "Mantener 30 segundos cada lado",
      },
    ],
  });
  ...
  await Expediente.create({
    ...
    medico: medico1._id,
    diagnostico:
      "Ruptura parcial LCA rodilla derecha post-intervención quirúrgica",
    motivoConsulta:
      "Rehabilitación post-quirúrgica, referido por Dr. Martínez (traumatología)",
    antecedentes:
      "Cirugía LCA 15/03/2024. Sin otras cirugías previas. Practica fútbol amateur.",
    ...
    evolucion: [
      {
        fecha: daysAgo(14),
        nota: "Primera sesión. Rango de movimiento: 0-45°. Inflamación moderada. Inicia protocolo fase 1.",
        medico: medico1._id,
      },
      {
        fecha: daysAgo(7),
        nota: "Segunda semana. ROM mejoró a 0-75°. Inflamación disminuida. Tolera bien los ejercicios.",
        medico: medico1._id,
      },
      {
        fecha: daysAgo(2),
        nota: "Tercera semana. ROM 0-90°. Sin dolor en reposo. Avanzar a fase 2 la próxima semana.",
        medico: medico1._id,
      },
    ],
  });
  ...
  await Expediente.create({
    ...
    motivoConsulta:
      "Dolor lumbar de 6 meses de evolución. Agravado con actividad física.",
    antecedentes:
      "Trabajo de oficina 8h/día. Sedentarismo. Sin cirugías previas.",
    alergias: "Penicilina",
    ...
    evolucion: [
      {
        fecha: daysAgo(21),
        nota: "Evaluación inicial. EVA 7/10. Flexión lumbar limitada. Inicio de programa de ejercicio terapéutico.",
        medico: medico1._id,
      },
      {
        fecha: daysAgo(10),
        nota: "Segunda evaluación. EVA 4/10. Mejora notable en movilidad. Continuar con programa actual.",
        medico: medico1._id,
      },
    ],
  });
